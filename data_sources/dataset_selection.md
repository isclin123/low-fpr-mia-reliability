...
- Raw download/cache location: `data_sources/`
- Cleaned data and split files: `data_processed/`
- Data provenance notes: `data_sources/data_sources.md`
- Preprocessing log: `data_processed/preprocessing_log.md`
...
- Record subset size and seed in `analysis/results/core/run_config.json`.
