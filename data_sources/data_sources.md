...
Core and expanded raw datasets have been downloaded or cached in `data_sources/`.

Raw data locations:

- `credit_default`: `data_sources/credit_default/`
- `covertype`: `data_sources/covertype/`
- `adult_income`: `data_sources/adult_income/`
- `bank_marketing`: `data_sources/bank_marketing/`
- `diabetes_readmission`: `data_sources/diabetes_readmission/`

Cleaned data and reproducible member/non-member splits are available for all five active datasets in `data_processed/`: `credit_default`, `covertype`, `adult_income`, `bank_marketing`, and `diabetes_readmission`.
...
- Local raw zip: `data_sources/credit_default/default_of_credit_card_clients.zip`
- Local extracted file: `data_sources/credit_default/default of credit card clients.xls`
- File sizes:
  - zip: 5.3 MB
  - xls: 5.3 MB
- SHA-256:
...
- Dependency note:
  ...
  - `xlrd` has been added to `analysis/requirements.txt`.
...
- Access date: 2026-06-02
- Local sklearn cache:
  - `data_sources/covertype/sklearn_cache/covertype/samples_py3`
  - `data_sources/covertype/sklearn_cache/covertype/targets_py3`
- Local compressed raw arrays:
  - `data_sources/covertype/covertype_raw_arrays.npz`
- File sizes:
...
- DOI: `10.24432/C5XW20`
- Access date: 2026-06-02
- Local raw zip: `data_sources/adult_income/adult.zip`
- Local extracted files:
  - `data_sources/adult_income/adult.data`
  - `data_sources/adult_income/adult.test`
  - `data_sources/adult_income/adult.names`
  - `data_sources/adult_income/old.adult.names`
  - `data_sources/adult_income/Index`
- File sizes:
  - zip: 608 KB
  - `adult.data`: 3.8 MB
  - `adult.test`: 1.9 MB
...
- DOI: `10.24432/C5K306`
- Access date: 2026-06-02
- Local raw zip: `data_sources/bank_marketing/bank_marketing.zip`
- Local nested zips:
  - `data_sources/bank_marketing/bank.zip`
  - `data_sources/bank_marketing/bank-additional.zip`
- Local extracted files:
  - `data_sources/bank_marketing/bank-additional/bank-additional-full.csv`
  - `data_sources/bank_marketing/bank-additional/bank-additional.csv`
  - `data_sources/bank_marketing/bank-additional/bank-additional-names.txt`
  - `data_sources/bank_marketing/bank-full.csv`
  - `data_sources/bank_marketing/bank.csv`
  - `data_sources/bank_marketing/bank-names.txt`
- File sizes:
  - outer zip: 1.0 MB
...
- DOI: `10.24432/C5230J`
- Access date: 2026-06-02
- Local raw zip: `data_sources/diabetes_readmission/diabetes_130_us_hospitals.zip`
- Local extracted files:
  - `data_sources/diabetes_readmission/diabetic_data.csv`
  - `data_sources/diabetes_readmission/IDS_mapping.csv`
- File sizes:
  - zip: 3.0 MB
...
Dataset loading and preprocessing have been implemented in `analysis/src/mia_eval/data.py`.

Cleaned core outputs:

- `data_processed/credit_default/cleaned_dataset.npz`
- `data_processed/credit_default/member_nonmember_split.npz`
- `data_processed/covertype/cleaned_dataset.npz`
- `data_processed/covertype/member_nonmember_split.npz`

Preprocessing details are recorded in `data_processed/preprocessing_log.md`.
