...
- Input path: `analysis/examples/example_scores.npz`
- Input format: `npz`
...
- main_metrics: `analysis/results/audit_tool_example_npz/metrics/main_metrics.csv`
- confidence_intervals: `analysis/results/audit_tool_example_npz/metrics/confidence_intervals.csv`
- fixed_threshold_intervals: `analysis/results/audit_tool_example_npz/metrics/fixed_threshold_intervals.csv`
- sample_size_repeats: `analysis/results/audit_tool_example_npz/subsampling/sample_size_repeats.csv`
- sample_size_sensitivity: `analysis/results/audit_tool_example_npz/subsampling/sample_size_sensitivity.csv`
- sample_size_skipped: `analysis/results/audit_tool_example_npz/subsampling/sample_size_skipped.csv`
- tail_resolution_warnings: `analysis/results/audit_tool_example_npz/diagnostics/tail_resolution_warnings.csv`
- run_config: `analysis/results/audit_tool_example_npz/run_config.json`
- run_summary: `analysis/results/audit_tool_example_npz/run_summary.md`
