...
def extract_attack_scores(
    ...
    *,
    ...
    model_dir = project_root / "analysis" / "results" / model_subdir / dataset_name / model_name
    ...
    output_dir = project_root / "analysis" / "results" / output_subdir / dataset_name / model_name
