...
EXPANDED_RESULTS = PROJECT_ROOT / "analysis" / "results" / EXPANDED_RUN
HARDENED_RESULTS = PROJECT_ROOT / "analysis" / "results" / "final_ci_hardening"
EXPANDED_TABLES = PROJECT_ROOT / "figures_tables" / "expanded"
FINAL_TABLE_DIR = PROJECT_ROOT / "figures_tables" / "final_tables"
APPENDIX_TABLE_DIR = PROJECT_ROOT / "figures_tables" / "appendix_tables"
...
def build_model_comparison_table(summary: pd.DataFrame) -> pd.DataFrame:
    ...
    write_markdown_table(
        ...
        "Source: `figures_tables/expanded/expanded_model_comparison_summary.csv`; point estimates are descriptive.",
        md,
    )
    return table
