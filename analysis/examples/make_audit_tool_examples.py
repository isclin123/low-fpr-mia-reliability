...
DEFAULT_SOURCE = PROJECT_ROOT / "analysis/results/core/attack_scores/credit_default/random_forest/attack_scores.npz"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "analysis/examples"
