...
/tmp/mia_repro_smoke_20260603/bin/python -m pip install -r analysis/requirements.txt
```
...
```bash
/tmp/mia_repro_smoke_20260603/bin/python analysis/examples/make_audit_tool_examples.py
```

NPZ audit-tool smoke:

```bash
/tmp/mia_repro_smoke_20260603/bin/python analysis/run_audit_tool.py \
  --input analysis/examples/example_scores.npz \
  --input-format npz \
  --output-dir analysis/results/clean_env_smoke_npz \
...
/tmp/mia_repro_smoke_20260603/bin/python analysis/run_audit_tool.py \
  ...
  --input-format csv \
  --output-dir analysis/results/clean_env_smoke_csv \
...
- `analysis/results/clean_env_smoke_npz/`
- `analysis/results/clean_env_smoke_csv/`
...
- A pinned lockfile was later created and this smoke path was rerun; see `release/reproducibility_package/locked_env_smoke.md`.
