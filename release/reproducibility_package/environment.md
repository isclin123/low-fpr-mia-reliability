...
Current `analysis/requirements.txt`:
...
Most commands insert `analysis/src` automatically. For interactive use, set:
...
The fast audit-tool reporting path has been validated in a fresh virtual environment installed from `analysis/requirements-lock.txt`. See `release/reproducibility_package/locked_env_smoke.md`.
