...
/tmp/mia_repro_lock_smoke_20260603/bin/python -m pip install -r analysis/requirements-lock.txt
```

The installed package freeze was saved to:

- `analysis/results/lock_env_smoke_freeze.txt`
...
```bash
/tmp/mia_repro_lock_smoke_20260603/bin/python analysis/examples/make_audit_tool_examples.py
```

NPZ audit-tool smoke:

```bash
/tmp/mia_repro_lock_smoke_20260603/bin/python analysis/run_audit_tool.py \
  --input analysis/examples/example_scores.npz \
  --input-format npz \
  --output-dir analysis/results/lock_env_smoke_npz \
...
/tmp/mia_repro_lock_smoke_20260603/bin/python analysis/run_audit_tool.py \
  ...
  --input-format csv \
  --output-dir analysis/results/lock_env_smoke_csv \
...
- `analysis/results/lock_env_smoke_npz/`
- `analysis/results/lock_env_smoke_csv/`
