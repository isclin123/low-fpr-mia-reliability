...
| Author block | `release/manuscript_package/manuscript_q1.tex` | `Sicheng Yi` present in source and PDF metadata |
| Canonical Q1 draft author line | `07_drafts/full_draft_q1.md` | `Sicheng Yi` present |
| Package Q1 Markdown author line | `release/manuscript_package/manuscript_q1.md` | `Sicheng Yi` present |
| Figure 4 tail-evidence repair | `release/manuscript_package/manuscript_q1.tex` | Figure 4 now shows TPR@0.1%FPR audit-size uncertainty rather than the less central AUC-width diagnostic |
| Citation rendering repair | `release/manuscript_package/manuscript_q1.tex` | Pseudo-citations replaced by bracket numeric citations with internal reference anchors |
...
| Package Q1 Markdown bridge | `release/manuscript_package/manuscript_q1.md` | Present |
| Package Q1 LaTeX source | `release/manuscript_package/manuscript_q1.tex` | Present |
| Q1 PDF proof | `release/manuscript_package/proofs/manuscript_q1.pdf` | Present |
| Q1 rendered proof pages | `release/manuscript_package/proofs/rendered_pages_q1/page-01.png` through `page-24.png` | 24 pages present |
| Q1 proof QA | `release/manuscript_package/proofs/manuscript_q1_latex_proof_qa.md` | Present |
| Flattened Q1 figure rasters | `release/manuscript_package/figures/flattened/*.png` | 10 present, with 9 referenced by the current proof; no alpha channel |
...
- `release/manuscript_package/manuscript_near_final.md`
- `release/manuscript_package/proofs/manuscript_near_final.pdf`
...
- `release/manuscript_package/` is already a stable package directory.
...
| Package manuscript source | `release/manuscript_package/manuscript_near_final.md` | Present |
| PDF proof | `release/manuscript_package/proofs/manuscript_near_final.pdf` | Present |
| Rendered proof pages | `release/manuscript_package/proofs/rendered_pages/page-01.png` through `page-27.png` | 27 pages present |
| Data/Code Availability statement | `release/data_code_availability_statement.md` | Present |
| Release route plan | `release/release_route_and_licence_plan.md` | Present |
| Release licence notes | `release/reproducibility_package/release_licence_notes.md` | Present |
| Pinned environment lock | `analysis/requirements-lock.txt` | Present |
