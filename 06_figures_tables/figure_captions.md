...
- Diagnostic figures were generated from `05_analysis/generate_figures.py` using the `core` and `model_extension_hgb` result folders.
- Expanded manuscript-facing figures were generated from `05_analysis/generate_expanded_outputs.py` using `05_analysis/results/expanded_tabular_stage1/` and the compact summary outputs under `06_figures_tables/expanded/`.
...
- Uncertainty claims should cite `06_figures_tables/final_tables/table3_main_mia_metrics_hardened.md` or the appendix CI tables, not the heatmap by itself.
...
- `06_figures_tables/expanded/expanded_accuracy_gap_vs_best_auc.png`
- `06_figures_tables/expanded/expanded_auc_width_by_audit_size.png`
- `06_figures_tables/expanded/expanded_best_auc_heatmap.png`
- `06_figures_tables/expanded/expanded_neg_loss_low_fpr_heatmaps.png`
- `06_figures_tables/diagnostics/audit_size_auc_width_neg_loss.png`
- `06_figures_tables/diagnostics/audit_size_tpr001_width_neg_loss.png`
- `06_figures_tables/diagnostics/audit_size_tpr_mean_neg_loss.png`
- `06_figures_tables/diagnostics/low_fpr_roc_neg_loss.png`
- `06_figures_tables/diagnostics/low_fpr_tpr_neg_loss.png`
- `06_figures_tables/diagnostics/model_comparison_best_auc.png`
- `06_figures_tables/diagnostics/score_distribution_credit_default_random_forest_neg_loss.png`
- `06_figures_tables/diagnostics/target_gap_vs_best_auc.png`
