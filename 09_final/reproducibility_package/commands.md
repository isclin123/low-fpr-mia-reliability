...
```bash
python3 05_analysis/run_experiment.py \
...
- `05_analysis/results/expanded_tabular_stage1/metrics/main_metrics.csv`
- `05_analysis/results/expanded_tabular_stage1/metrics/confidence_intervals.csv`
- `05_analysis/results/expanded_tabular_stage1/subsampling/sample_size_sensitivity.csv`
- `05_analysis/results/expanded_tabular_stage1/subsampling/sample_size_repeats.csv`

## 4. Expanded Figures and Sample-Size Requirements

```bash
python3 05_analysis/generate_expanded_outputs.py
```

Expected outputs:

- `06_figures_tables/expanded/expanded_best_auc_heatmap.{png,svg,pdf}`
- `06_figures_tables/expanded/expanded_neg_loss_low_fpr_heatmaps.{png,svg,pdf}`
- `06_figures_tables/expanded/expanded_accuracy_gap_vs_best_auc.{png,svg,pdf}`
- `06_figures_tables/expanded/expanded_auc_width_by_audit_size.{png,svg,pdf}`
- `06_figures_tables/expanded/expanded_model_comparison_summary.csv`
- `05_analysis/results/expanded_tabular_stage1/sample_size_requirements.md`

## 5. Selected Final CI Hardening

```bash
python3 05_analysis/run_final_ci_hardening.py \
  --source-run-name expanded_tabular_stage1 \
  --attack-score-subdir expanded_tabular_stage1/attack_scores \
  --summary-csv 06_figures_tables/expanded/expanded_model_comparison_summary.csv \
  --stage1-ci-csv 05_analysis/results/expanded_tabular_stage1/metrics/confidence_intervals.csv \
  --output-dir 05_analysis/results/final_ci_hardening \
  --n-bootstrap 1000 \
  --confidence 0.95 \
  --random-state 20260603
```
...
- `05_analysis/results/final_ci_hardening/selected_score_rows.csv`
- `05_analysis/results/final_ci_hardening/hardened_confidence_intervals.csv`
- `05_analysis/results/final_ci_hardening/stage1_vs_hardened_confidence_intervals.csv`
- `05_analysis/results/final_ci_hardening/hardening_summary.md`

## 6. Final Main and Appendix Tables

```bash
python3 05_analysis/generate_final_tables.py
```

Expected outputs:

- `06_figures_tables/final_tables/`
- `06_figures_tables/appendix_tables/`
...
for dataset in credit_default adult_income; do
  out="05_analysis/results/q1_stronger_score_appendix/${dataset}_random_forest"
...
```bash
python3 05_analysis/run_q1_lira_like_appendix.py \
  --datasets credit_default adult_income \
  --model random_forest \
  --attack-score-subdir expanded_tabular_stage1/attack_scores \
  --output-dir 05_analysis/results/q1_lira_like_appendix \
  --n-shadows 8 \
  --n-estimators 80 \
  --n-bootstrap 1000 \
  --n-repeats 200 \
...
- `05_analysis/results/q1_lira_like_appendix/tables/key_metrics.csv`: 4 rows.
- `05_analysis/results/q1_lira_like_appendix/tables/shadow_fit_summary.csv`: 2 rows.
- `05_analysis/results/q1_lira_like_appendix/tables/shadow_model_runs.csv`: 16 rows.
...
```bash
python3 05_analysis/run_q1_tie_rule_sensitivity.py \
  --attack-score-subdir expanded_tabular_stage1/attack_scores \
  --output-dir 05_analysis/results/q1_tie_rule_sensitivity \
  --fpr-levels 0.01 0.001
```

Expected tie-rule outputs and row counts:

- `05_analysis/results/q1_tie_rule_sensitivity/tie_rule_operating_points.csv`: 24 rows.
- `05_analysis/results/q1_tie_rule_sensitivity/paper_table_tie_rule_sensitivity.csv`: 8 rows.
- `05_analysis/results/q1_tie_rule_sensitivity/q1_tie_rule_sensitivity_summary.md`: paper-ready table and key readout.
...
```bash
python3 05_analysis/run_q1_split_seed_sensitivity.py \
...
- `05_analysis/results/q1_split_seed_sensitivity/split_seed_metric_rows.csv`: 45 rows.
- `05_analysis/results/q1_split_seed_sensitivity/split_seed_summary.csv`: 9 rows.
- `05_analysis/results/q1_split_seed_sensitivity/paper_table_split_seed_sensitivity.csv`: 3 rows.
- `05_analysis/results/q1_split_seed_sensitivity/q1_split_seed_sensitivity_summary.md`: paper-ready table and design note.
...
- `05_analysis/results/q1_label_uncertainty_stress/credit_default_random_forest_neg_loss/tables/label_uncertainty_repeats.csv`: 5,000 rows.
- `05_analysis/results/q1_label_uncertainty_stress/credit_default_random_forest_neg_loss/tables/label_uncertainty_summary.csv`: 25 rows.
- `05_analysis/results/q1_label_uncertainty_stress/credit_default_random_forest_neg_loss/tables/canonical_corruption_metrics.csv`: 25 rows.
- `05_analysis/results/q1_label_uncertainty_stress/credit_default_random_forest_neg_loss/tables/canonical_score_arrays.csv`: 5 rows.
- `05_analysis/results/q1_label_uncertainty_stress/credit_default_random_forest_neg_loss/tables/tail_resolution_warnings.csv`: 70 rows.
...
```bash
python3 -m py_compile 05_analysis/generate_expanded_outputs.py
python3 -m py_compile 05_analysis/generate_final_tables.py
python3 -m py_compile 05_analysis/run_q1_stronger_score_appendix.py
python3 -m py_compile 05_analysis/run_q1_lira_like_appendix.py
python3 -m py_compile 05_analysis/run_q1_tie_rule_sensitivity.py
python3 -m py_compile 05_analysis/run_q1_split_seed_sensitivity.py
python3 -m py_compile 05_analysis/run_q1_label_uncertainty_stress.py
```
