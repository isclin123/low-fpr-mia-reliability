...
- Host large generated result artifacts, especially the expanded-stage outputs under `05_analysis/results/`, as one or more Zenodo files if size limits and upload time are acceptable.
...
- Keep `09_final/manuscript_package/` as the near-final review package, not as the complete public data archive.
