...
| Artifact | Path |
|---|---|
| Synchronized Markdown reading copy | `09_final/manuscript_package/manuscript_q1.md` |
| Authoritative LaTeX source | `09_final/manuscript_package/manuscript_q1.tex` |
| Compiled PDF | `09_final/manuscript_package/manuscript_q1.pdf` |
| Rendered page proofs | `09_final/manuscript_package/proofs/rendered_pages_q1/page-*.png` |
| Contact sheet | `09_final/manuscript_package/proofs/manuscript_q1_contact_sheet.png` |
| arXiv source folder | `09_final/manuscript_package/arxiv_upload/` |
| arXiv upload zip | `09_final/manuscript_package/arxiv_upload.zip` |

## Build Commands

From `09_final/manuscript_package/`:
