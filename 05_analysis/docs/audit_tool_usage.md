...
Implementation status: implemented on 2026-06-03 in `05_analysis/src/mia_eval/audit_tool.py` and `05_analysis/run_audit_tool.py`.
...
```bash
python 05_analysis/run_audit_tool.py \
  --input 05_analysis/examples/example_scores.npz \
  --input-format npz \
  --output-dir 05_analysis/results/audit_tool_example \
...
python 05_analysis/run_audit_tool.py \
  ...
  --output-dir 05_analysis/results/audit_tool_csv_example
```
