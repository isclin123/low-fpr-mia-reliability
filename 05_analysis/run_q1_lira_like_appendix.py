...
def score_path(project_root: Path, attack_score_subdir: str, dataset: str, model: str) -> Path:
    return project_root / "05_analysis" / "results" / attack_score_subdir / dataset / model / "attack_scores.npz"


def metadata_path(project_root: Path, attack_score_subdir: str, dataset: str, model: str) -> Path:
    return project_root / "05_analysis" / "results" / attack_score_subdir / dataset / model / "metadata.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("05_analysis/results/q1_lira_like_appendix"))
