...
def load_clean_split(project_root: Path, dataset_name: str) -> CleanSplit:
    dataset_dir = project_root / "04_data_cleaned" / dataset_name
...
def train_target_model(
    ...
    *,
    ...
    output_dir = project_root / "05_analysis" / "results" / output_subdir / split.dataset_name / model_name
    ...
    metadata = {
        ...
        "dataset_metadata_path": str(
            (project_root / "04_data_cleaned" / split.dataset_name / "metadata.json").relative_to(project_root)
        ),
