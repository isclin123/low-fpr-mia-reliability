...
def load_score_arrays(
    ...
    *,
    ...
    score_dir = project_root / "05_analysis" / "results" / attack_score_subdir / dataset / model
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("05_analysis/results/core"))
