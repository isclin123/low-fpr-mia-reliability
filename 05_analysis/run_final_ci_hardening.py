...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--summary-csv", type=Path, default=Path("06_figures_tables/expanded/expanded_model_comparison_summary.csv"))
    parser.add_argument(
        "--stage1-ci-csv",
        type=Path,
        default=Path("05_analysis/results/expanded_tabular_stage1/metrics/confidence_intervals.csv"),
    )
    parser.add_argument("--output-dir", type=Path, default=Path("05_analysis/results/final_ci_hardening"))
