...
- Long CSV: `05_analysis/results/q1_tie_rule_sensitivity/tie_rule_operating_points.csv`
- Paper table CSV: `05_analysis/results/q1_tie_rule_sensitivity/paper_table_tie_rule_sensitivity.csv`
- Run config: `05_analysis/results/q1_tie_rule_sensitivity/run_config.json`
