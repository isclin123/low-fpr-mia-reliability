...
python3 05_analysis/run_q1_stronger_score_appendix.py \
  ...
  --model random_forest \
  --output-dir 05_analysis/results/q1_stronger_score_appendix/adult_income_random_forest
python3 05_analysis/run_audit_tool.py \
  --input 05_analysis/results/q1_stronger_score_appendix/adult_income_random_forest/score_arrays/stronger_scores.npz \
  --input-format npz \
  --output-dir 05_analysis/results/q1_stronger_score_appendix/adult_income_random_forest/audit_tool \
  --dataset adult_income \
  --model random_forest_reference_centered \
  --score-names ref_centered_neg_loss ref_logit_margin ref_z_logit_margin \
  --n-bootstrap 1000 \
