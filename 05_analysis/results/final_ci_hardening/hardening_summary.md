...
- Summary CSV used for row selection: `06_figures_tables/expanded/expanded_model_comparison_summary.csv`
- Output directory: `05_analysis/results/final_ci_hardening`
...
- Selected score rows: `05_analysis/results/final_ci_hardening/selected_score_rows.csv`
- Hardened intervals: `05_analysis/results/final_ci_hardening/hardened_confidence_intervals.csv`
- Stage1 comparison: `05_analysis/results/final_ci_hardening/stage1_vs_hardened_confidence_intervals.csv`
- Run config: `05_analysis/results/final_ci_hardening/run_config.json`
