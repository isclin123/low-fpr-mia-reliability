...
- Per-seed metric rows: `05_analysis/results/q1_split_seed_sensitivity/split_seed_metric_rows.csv`
- Metric summaries: `05_analysis/results/q1_split_seed_sensitivity/split_seed_summary.csv`
- Paper table: `05_analysis/results/q1_split_seed_sensitivity/paper_table_split_seed_sensitivity.csv`
- Run config: `05_analysis/results/q1_split_seed_sensitivity/run_config.json`
