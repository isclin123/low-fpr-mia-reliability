...
- Integrated a bounded shadow-model score-array check into the manuscript as Appendix H.
  - Script: `05_analysis/run_q1_lira_like_appendix.py`
  - Outputs: `05_analysis/results/q1_lira_like_appendix/`
...
- Integrated tie-rule sensitivity as Appendix I.
  - Script: `05_analysis/run_q1_tie_rule_sensitivity.py`
  - Outputs: `05_analysis/results/q1_tie_rule_sensitivity/`
...
- Added and ran split/seed sensitivity as Appendix J.
  - Script: `05_analysis/run_q1_split_seed_sensitivity.py`
  - Outputs: `05_analysis/results/q1_split_seed_sensitivity/`
...
- Regenerated `09_final/manuscript_package/manuscript_q1.md` from the current TeX source as a synchronized reading copy. The authoritative source remains `manuscript_q1.tex`.
...
- Python compile check passed for:
  ...
  - `05_analysis/run_q1_stronger_score_appendix.py`
  - `05_analysis/run_q1_lira_like_appendix.py`
  - `05_analysis/run_q1_tie_rule_sensitivity.py`
  - `05_analysis/run_q1_split_seed_sensitivity.py`
  - `05_analysis/run_q1_label_uncertainty_stress.py`
...
- `09_final/manuscript_package/arxiv_upload.zip`

Do not upload the whole `09_final/manuscript_package/` directory.

## Remaining external-only item

The DOI is now reserved and inserted. The remaining external-only action is to publish the Zenodo record containing `09_final/zenodo_release/mia_low_fpr_reliability_reproducibility_v1.0.0.zip` before or at the same time as the arXiv version that cites `https://doi.org/10.5281/zenodo.20552369`.
